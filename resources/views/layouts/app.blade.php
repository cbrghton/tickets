        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-2">
                    ...
                    <!-- Timer -->
                    <div class="panel panel-flat time">
                        <div class="panel-heading">
                            <h6 class="panel-title"><i class="icon-watch position-left"></i> Tiempo</h6>
...
<div class="navbar navbar-default navbar-fixed-bottom footer">
    ...
    <div class="navbar-collapse collapse" id="footer">
        <div class="navbar-text">
            <a href="{{ url('https://www.semovi.cdmx.gob.mx') }}" class="navbar-link">SECRETARIA DE MOVILIDAD DE LA CIUDAD DE MÉXICO</a> DIRECCION DE SISTEMAS
        </div>
    </div>
</div>
<!-- /footer -->
